...
namespace FormRecognizerQuickStart
{
    class Program
    {
        ...
        private static string subscriptionKey = "2f3d81b33c17440ca1c82427ba78e560";
        private static string formRecognizerEndpoint = "https://formrecognitiondemo.cognitiveservices.azure.com/";
            ...
            IFormRecognizerClient formClient)
        {
            try
            {
                ...
                Console.WriteLine(models.ModelsProperty.Count);
        ...
        private static void TestPrint(ExtractedPage page)
        {
            foreach (var item in page.KeyValuePairs)
            {
